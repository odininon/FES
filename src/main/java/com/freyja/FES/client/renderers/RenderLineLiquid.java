...
import com.freyja.FES.common.blocks.BlockLineLiquid;
...
public class RenderLineLiquid implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer)
    {
        ...
        for (int i = 0; i < 6; i++)
            directions[i] = ((BlockLineLiquid) block).canConnectOnSide(world, i, x, y, z);
